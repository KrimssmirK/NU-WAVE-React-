...
export default function FeaturedProduct() {
  return (
    <>
        ...
        <div className="col-6 col-md-4 col-lg-3">
            <div className="card prod-container">
                <img src={prod5} alt="product 5" className="img-fluid img-thumbnail w-100 prod-img" />
                <div className="card-body text-truncate">
        ...
        <div className="col-6 col-md-4 col-lg-3">
            <div className="card prod-container">
                <img src={prod6} alt="product 6" className="img-fluid img-thumbnail w-100 prod-img" />
                <div className="card-body text-truncate">
                    <span>Escential</span>
                </div>
            </div>
        ...
        <div className="col-6 col-md-4 col-lg-3">
            <div className="card prod-container">
                <img src={prod7} alt="product 7" className="img-fluid img-thumbnail w-100 prod-img" />
                <div className="card-body text-truncate">
                    <span>Micro Cheap</span>
                </div>
            </div>
        </div>
        <div className="col-6 col-md-4 col-lg-3">
            <div className="card prod-container">
                <img src={prod8} alt="product 8" className="img-fluid img-thumbnail w-100 prod-img" />
                <div className="card-body text-truncate">
                    <span>MoringAu Naturel</span>
                </div>
            </div>
        </div>
    </>
